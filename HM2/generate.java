...
public class generate {
    public static void main(String[] args)   {
		int columnsNumber = 21;
		int rowsNumber = 21;
		int[][] maze = MapGenerator.generateMaze(columnsNumber, rowsNumber,	 
												true, 3);
		MapGenerator.print(columnsNumber, rowsNumber, maze);
    }
}
...
class Link2I {
	public Link2I(Point2I p1, Point2I p2, double distance) {
		this.p1 = p1;
		this.p2 = p2;
